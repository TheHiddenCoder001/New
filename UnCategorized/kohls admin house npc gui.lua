...
local tv14 = XTRA:Toggle('└  Spam CMD', {flag = "toggle14"})
...
CRDTS:Section("doge#7202")
CRDTS:Section("shoutout to duh#0100")
CRDTS:Section("Wally's ui lib v2")

XTRA:Button("Remove Building Bricks", function()
    game:GetService("Workspace").Terrain["_Game"].Workspace["Building Bricks"]:Destroy()
end)
